    ...
    <>
      <div className="min-h-screen bg-[#f8fafc] relative overflow-hidden">
        ...
        <div className="relative pt-28 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-[#f4f8ff] text-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
            ...
            >
              ...
              <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed">
                We combine modern web development with data-driven marketing to
                build brands that grow and convert.We follow Google SEO best
                practices as mentioned in{" "}
                <a
          ...
          {/* Bottom Curve */}
          <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]"></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-500 mb-6 text-sm">
                Best for small businesses, blogs, and rapid deployment.
              </p>
        ...
        <div className="bg-white py-20 border-t border-gray-100 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            >
              <div>
                ...
                <p className="text-gray-500">
                  Accelerate your business with our all-in-one SEO & Marketing
                  packages.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <motion.div
                variants={itemVariants}
                className="p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:border-purple-300 transition-all hover:shadow-lg group"
              >
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-purple-600" /> Complete
                    Website Setup
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700 font-semibold bg-green-50 p-1 rounded">
                    <Check className="w-4 h-4 text-green-600" /> On-Page SEO
                    Optimization
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-purple-600" /> 1 Year Free
                    Hosting
                  </li>
                </ul>
                <Link
              ...
              >
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-purple-600" /> Website +
                    Hosting (1 Year)
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700 font-semibold bg-purple-100/50 p-1 rounded">
                    <Check className="w-4 h-4 text-purple-600" /> 1 Month SEO
                    Service
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-purple-600" /> Social Media
                    Reel (1 per day)
                  </li>
                </ul>
                <Link
              ...
              <motion.div
                variants={itemVariants}
                className="p-8 rounded-2xl bg-white border border-green-200 hover:border-green-400 hover:shadow-green-100 hover:shadow-lg transition-all group"
              >
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex gap-2 text-sm text-gray-700 font-medium">
                    <Check className="w-4 h-4 text-green-600" /> Off-Page SEO
                    (Backlinks)
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-green-600" /> Social Media
                    Creatives
                  </li>
                  <li className="flex gap-2 text-sm text-gray-700">
                    <Check className="w-4 h-4 text-green-600" /> 1 Reel per day
                  </li>
                </ul>
                <Link
                  href="/contact"
              ...
              <table className="w-full text-left border-collapse bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="p-4 border-b border-gray-200 font-semibold text-gray-700 text-right">
                      Price (INR)
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-4 text-gray-600 text-sm">
                      Backlinks & authority building for existing websites
                    </td>
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-medium text-gray-900">
                      Social Media Content (1 Month)
                    </td>
                    <td className="p-4 text-gray-600 text-sm">
                      Creative videos (1 reel in a day)
                    </td>
                    <td className="p-4 text-gray-900 font-bold text-right">
                      ₹3,000
                    </td>
