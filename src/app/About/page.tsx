...
const AboutClient: React.FC = () => {
  ...
  // 🔥 tumhara poora existing JSX yahin rahega
      ...
      <div className="pt-24 min-h-screen bg-white relative overflow-hidden">
        ...
        <div className="relative pb-2 pt-20 px-4 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              DigiWebx is more than just an Company we are your long-term
              digital growth partner. From strategy and design to engineering
              and marketing, we craft digital experiences that help brands scale
              faster, connect deeper, and lead confidently.
            </motion.p>
        ...
        <div className="py-24 max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                To democratize access to premium digital technology for
                businesses of all sizes. We believe every brand deserves a
                world-class digital presence that drives real, measurable
                results.
              </p>
              ...
              <div className="relative bg-white border border-gray-100 p-8 rounded-3xl shadow-xl">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 mt-2">
                      To become the most trusted digital transformation agency
                      in India.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 mt-2">
                      We treat your business like our own. No shortcuts, just
                      excellence.
                    </p>
                  </div>
                </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              The principles that guide every pixel we design and every line of
              code we write.
            </p>
          </div>
            ...
            {[
              {
                icon: Lightbulb,
                title: "Innovation",
                desc: "We stay ahead of the curve, using the latest tech stacks like Next.js and AI-driven marketing tools.",
              ...
              },
              {
                icon: ShieldCheck,
                title: "Integrity",
                desc: "No hidden fees, no false promises. We believe in complete transparency with our clients.",
                color: "text-blue-500",
                bg: "bg-blue-50",
              },
              {
                icon: Trophy,
                title: "Excellence",
                desc: "Good enough is not enough. We strive for perfection in design, performance, and SEO rankings.",
              ...
              >
                <div
                  className={`w-14 h-14 ${val.bg} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="bg-gray-900 text-white py-20 px-4 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Built by Experts, Powered by Passion
            </h2>
