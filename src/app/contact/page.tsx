                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="animate-pop-in pt-2" style={getDelay(5)}>
                          <button
                            ...
                            "
                          >
                            <span className={`truncate transition-all duration-300 ${isSubmitting ? '-translate-x-96' : 'group-active:-translate-x-96 group-focus:translate-x-96'}`}>
                              Send Message
                            </span>

                            <div className={`absolute flex flex-row justify-center items-center gap-2 transition-all duration-300 ${isSubmitting ? 'translate-x-0' : '-translate-x-96 group-active:translate-x-0 group-focus:translate-x-0'}`}>
                  ...
                  <div className="mt-10 pt-8 border-t border-purple-100/50">
                    ...
                    <div className="flex gap-4">
                      {[
                        ...
                        { Icon: Linkedin, href: "https://www.linkedin.com/in/ashish-dubey-26aaaa1b4", color: "hover:bg-blue-700" },
